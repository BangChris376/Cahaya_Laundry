    ...
    <footer className="bg-foreground text-background py-12">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          >
            ...
            <p className="text-background/70 max-w-xs">
              Laundry terpercaya di Ngaliyan dengan layanan antar jemput gratis
            </p>
          </motion.div>
          ...
          >
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-primary/20 hover:bg-primary/30 text-background px-4 py-2 rounded-full transition-colors"
            >
        ...
        <div className="border-t border-background/10 mt-10 pt-6 text-center text-background/50 text-sm">
          © {currentYear} Cahaya Laundry PP. Cepat, Bersih, Rapi & Wangi.
        </div>
      </div>
    </footer>
  );
