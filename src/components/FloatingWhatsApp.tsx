...
const FloatingWhatsApp = () => {
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.9 }}
      className="fixed bottom-6 right-6 z-50 bg-gradient-cta w-16 h-16 rounded-full flex items-center justify-center shadow-float group"
    >
      ...
      {/* WhatsApp Icon */}
      <svg
        className="w-8 h-8 text-primary-foreground relative z-10"
        fill="currentColor"
        viewBox="0 0 24 24"
      >
